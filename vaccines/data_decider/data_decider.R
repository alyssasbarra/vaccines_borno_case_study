...
if (nrow(regular_ages[data %in% c(0, 1)]) > 0) {
  ...
  variance <- se ^ 2 * 2.25 ## Inflate by design effect according to DHS official/unocfficial rule of thumb 
...
keep[ihme_loc_id=="" & nid==264590, `:=` (ihme_loc_id="MEX", parent_location="MEX")]  # weird that ihme_loc_id assignment is missing?
