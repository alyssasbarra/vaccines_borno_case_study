...
prep_for_tabulation <- function(nid, team="gbd", vaccines.=vaccines, filter_table=NA) {
  ...
  if (check) {
    ...
    if (team=="lbd") {
      ...
      # data[(!is.na(get(paste0(vax_stem_col, "_dose_from_card"))) &
      #         get(paste0(vax_stem_col, "_dose")) == get(paste0(vax_stem_col, "_dose_from_card"))) |   ## doses are from card
      #      (is.na(get(paste0(vax_stem_col, "_ever"))) &
      #         !is.na(get(paste0(vax_stem_col, "_dose")))) |                                           ## don't have an 'ever' gateway at all
      #      (!is.na(get(paste0(vax_stem_col, "_ever"))) &
      #         get(paste0(vax_stem_col, "_dose")) == get(paste0(vax_stem_col, "_dose_from_recall")) &
      #         get(paste0(vax_stem_col, "_dose_from_recall")) != get(paste0(vax_stem_col, "_ever")) &  ## not missing ever information but recall doesn't match it
      #         get(paste0(vax_stem_col, "_dose_from_recall")) != "At least 1")]                        ##
